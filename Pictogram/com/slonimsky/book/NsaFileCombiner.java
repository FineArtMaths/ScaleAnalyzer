...
public class NsaFileCombiner {
	...
	public static void main(String[] args) throws IOException {
		...
		FileWriter fw = new FileWriter(TexFileConstants.TEX_BASE_DIRECTORY 
				...
				+ TexFileConstants.TEX_DIR_DELIMITER 
				+ TexFileConstants.TEX_NSA_DOC_BOOK_FILENAME);
		...
		// Close the file
		fw.close();
		System.out.println("\nDone -- now copy nsa_slonimsky_book.tex to the out directory and run pdflatex on it");
	}
}
